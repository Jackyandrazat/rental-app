<x-app-layout>
    <div class="max-w-lg mx-auto mt-10">
        <h1 class="text-2xl font-semibold mb-4">Add New Car</h1>
        <form action="{{ route('cars.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6">
                ...
                <input type="text" name="license_plate" id="license_plate" placeholder="Enter Plate"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
            <div class="mb-6">
                <label for="rental_rate_per_day" class="block text-gray-700 text-sm font-bold mb-2">Rental Rate:</label>
                <input type="text" name="rental_rate_per_day" id="rental_rate_per_day" placeholder="Enter Rate"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
            </div>
